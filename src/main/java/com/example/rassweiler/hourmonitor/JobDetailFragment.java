package com.example.rassweiler.hourmonitor;
...
import com.example.rassweiler.hourmonitor.dummy.DummyContent;
...
public class JobDetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mItem != null) {
            ((TextView) rootView.findViewById(R.id.job_detail)).setText(mItem.content);
        }
